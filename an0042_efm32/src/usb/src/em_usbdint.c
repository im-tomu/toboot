...
__ramfunc static void Handle_USB_GINTSTS_ENUMDONE  ( void );
__ramfunc static void Handle_USB_GINTSTS_IEPINT    ( void );
__ramfunc static void Handle_USB_GINTSTS_OEPINT    ( void );
__ramfunc static void Handle_USB_GINTSTS_RESETDET  ( void );
#if defined( NO_RAMFUNCS )
__ramfunc static void Handle_USB_GINTSTS_SOF       ( void );
#endif
__ramfunc static void Handle_USB_GINTSTS_USBRST    ( void );
__ramfunc static void Handle_USB_GINTSTS_USBSUSP   ( void );
__ramfunc static void Handle_USB_GINTSTS_WKUPINT   ( void );
#if defined( USB_DOEP0INT_STUPPKTRCVD )
__ramfunc static void HandleOutEpIntr( uint32_t status, USBD_Ep_TypeDef *ep );
#else
__ramfunc static void ProcessSetup                 ( void );
__ramfunc static void ProcessOepData               ( USBD_Ep_TypeDef *ep );
#endif
 ...
 */
__ramfunc void USB_IRQHandler( void )
{
  uint32_t status;
